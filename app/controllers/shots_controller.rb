class ShotsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @shot.save
        format.html { redirect_to @shot, notice: 'Знімок успішно створено.' }
  ...
  def update
    respond_to do |format|
      if @shot.update(shot_params)
        format.html { redirect_to @shot, notice: 'Знімок успішно оновлено.' }
  ...
  def destroy
    @shot.destroy
    respond_to do |format|
      format.html { redirect_to shots_url, notice: 'Знімок успішно видалено.' }
